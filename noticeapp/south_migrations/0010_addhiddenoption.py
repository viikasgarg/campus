...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('noticeapp_category', 'hidden', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Notice.hidden'
        db.add_column('noticeapp_notice', 'hidden', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Category.hidden'
        db.delete_column('noticeapp_category', 'hidden')

        # Deleting field 'Notice.hidden'
        db.delete_column('noticeapp_notice', 'hidden')
