...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CourseReadTracker'
        db.create_table('noticeapp_coursereadtracker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[AUTH_USER])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['noticeapp.Course'], null=True, blank=True)),
            ('time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('noticeapp', ['CourseReadTracker'])

        # Adding model 'NoticeReadTracker'
        db.create_table('noticeapp_noticereadtracker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[AUTH_USER])),
            ('notice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['noticeapp.Notice'], null=True, blank=True)),
            ('time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('noticeapp', ['NoticeReadTracker'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CourseReadTracker'
        db.delete_table('noticeapp_coursereadtracker')

        # Deleting model 'NoticeReadTracker'
        db.delete_table('noticeapp_noticereadtracker')
