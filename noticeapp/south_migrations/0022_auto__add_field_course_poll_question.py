...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.poll_question'
        db.add_column('noticeapp_course', 'poll_question',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.poll_question'
        db.delete_column('noticeapp_course', 'poll_question')
