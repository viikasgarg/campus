...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('noticeapp_profile', 'autosubscribe', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Profile.autosubscribe'
        db.delete_column('noticeapp_profile', 'autosubscribe')
