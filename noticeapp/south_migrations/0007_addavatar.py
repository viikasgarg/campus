...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('noticeapp_profile', 'avatar', self.gf(get_image_field_full_name())(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Profile.avatar'
        db.delete_column('noticeapp_profile', 'avatar')
