...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notice.headline'
        db.add_column('noticeapp_notice', 'headline', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Notice.headline'
        db.delete_column('noticeapp_notice', 'headline')
