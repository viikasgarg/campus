...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReadTracking.courses'
        db.alter_column('noticeapp_readtracking', 'courses', self.gf('annoying.fields.JSONField')(null=True))


    def backwards(self, orm):

        # Changing field 'ReadTracking.courses'
        db.alter_column('noticeapp_readtracking', 'courses', self.gf('django.db.models.TextField')())
