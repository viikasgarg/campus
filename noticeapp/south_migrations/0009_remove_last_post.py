...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('noticeapp_notice', 'last_post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_post_in_notice', null=True, to=orm['noticeapp.Post'], blank=True), keep_default=False)

        # Adding field 'Course.last_post'
        db.add_column('noticeapp_course', 'last_post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_post_in_course', null=True, to=orm['noticeapp.Post'], blank=True), keep_default=False)
