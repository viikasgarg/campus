...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('noticeapp_pollansweruser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poll_answer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', to=orm['noticeapp.PollAnswer'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='poll_answers', to=orm[AUTH_USER])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('noticeapp', ['PollAnswerUser'])

        # Adding model 'PollAnswer'
        db.create_table('noticeapp_pollanswer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='poll_answers', to=orm['noticeapp.Notice'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('noticeapp', ['PollAnswer'])

        # Adding field 'Course.poll_type'
        db.add_column('noticeapp_course', 'poll_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('noticeapp_pollansweruser')

        # Deleting model 'PollAnswer'
        db.delete_table('noticeapp_pollanswer')

        # Deleting field 'Course.poll_type'
        db.delete_column('noticeapp_course', 'poll_type')
    ...
    models = {
        ...
        'noticeapp.pollanswer': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'poll_answers'", 'to': "orm['noticeapp.Notice']"})
        },
