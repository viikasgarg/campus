...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('noticeapp_post', 'on_moderation', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Course.on_moderation'
        db.add_column('noticeapp_course', 'on_moderation', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Post.on_moderation'
        db.delete_column('noticeapp_post', 'on_moderation')

        # Deleting field 'Course.on_moderation'
        db.delete_column('noticeapp_course', 'on_moderation')
