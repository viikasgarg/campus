...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('noticeapp_profile', 'ban_till')

        # Deleting field 'Profile.ban_status'
        db.delete_column('noticeapp_profile', 'ban_status')


    def backwards(self, orm):

        # Adding field 'Profile.ban_till'
        db.add_column('noticeapp_profile', 'ban_till', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.ban_status'
        db.add_column('noticeapp_profile', 'ban_status', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)
