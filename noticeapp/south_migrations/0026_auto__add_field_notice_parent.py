...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notice.parent'
        db.add_column('noticeapp_notice', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child_notices', null=True, to=orm['noticeapp.Notice']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notice.parent'
        db.delete_column('noticeapp_notice', 'parent_id')
    ...
    models = {
        ...
        'noticeapp.notice': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'child_notices'", 'null': 'True', 'to': "orm['noticeapp.Notice']"}),
            'position': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
