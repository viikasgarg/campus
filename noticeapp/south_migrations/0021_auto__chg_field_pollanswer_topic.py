...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PollAnswer.course'
        db.alter_column('noticeapp_pollanswer', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['noticeapp.Course']))

    def backwards(self, orm):

        # Changing field 'PollAnswer.course'
        db.alter_column('noticeapp_pollanswer', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['noticeapp.Notice']))
