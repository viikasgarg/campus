...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('noticeapp_post', 'markup')

        # Deleting field 'Profile.markup'
        db.delete_column('noticeapp_profile', 'markup')


    def backwards(self, orm):

        # Adding field 'Post.markup'
        db.add_column('noticeapp_post', 'markup', self.gf('django.db.models.fields.CharField')(default='bbcode', max_length=15), keep_default=False)

        # Adding field 'Profile.markup'
        db.add_column('noticeapp_profile', 'markup', self.gf('django.db.models.fields.CharField')(default='bbcode', max_length=15), keep_default=False)
