...
from noticeapp.compat import get_image_field_class
...
class NoticeappProfile(models.Model):
    """
    ...
    avatar = get_image_field_class()(_('Avatar'), blank=True, null=True,
        upload_to=util.FilePathGenerator(to='noticeapp/avatar'))
    autosubscribe = models.BooleanField(_('Automatically subscribe'),
        help_text=_('Automatically subscribe to courses that you answer'),
    ...
    def save(self, *args, **kwargs):
        ...
        super(NoticeappProfile, self).save(*args, **kwargs)
