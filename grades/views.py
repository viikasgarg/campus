...
from profiles.models import Student, UserPreference, Faculty, SchoolYear
from profiles.helper_functions import Struct
from profiles.uno_report import replace_spreadsheet
...
def view_comment_codes(request):
    ...
    for comment in comments:
        msg += "%s <br/>" % (comment,)
    return render_to_response('campus/generic_msg.html', {'msg': msg,}, RequestContext(request, {}),)
