...
from .xl_report import XlReport
from .uno_report import *
...
class Importer:
    ...
    def import_alumni_note(self, sheet):
        from alumni.models import Alumni, AlumniNote, AlumniNoteCategory
        x, header, inserted, updated = self.import_prep(sheet)
        name = None
        while x < sheet.nrows:
            with transaction.commit_manually():
    ...
    def import_alumni_email(self, sheet):
        from alumni.models import Alumni, AlumniEmail
        x, header, inserted, updated = self.import_prep(sheet)
        name = None
        while x < sheet.nrows:
            with transaction.commit_manually():
    ...
    def import_alumni_number(self, sheet):
        from alumni.models import Alumni, AlumniPhoneNumber
        x, header, inserted, updated = self.import_prep(sheet)
        name = None
        while x < sheet.nrows:
            with transaction.commit_manually():
    ...
    def import_college_enrollment(self, sheet):
        from alumni.models import Alumni, College, CollegeEnrollment
        x, header, inserted, updated = self.import_prep(sheet)
        name = None
        while x < sheet.nrows:
            with transaction.commit_manually():
    ...
    def import_grades(self, course, marking_period):
        ...
        from grades.models import Grade,GradeComment
        try:
