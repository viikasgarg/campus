...
from profiles.models import Student, SchoolYear, GradeLevel, Faculty, Cohort
from schedule.calendar import Calendar
from schedule.models import MarkingPeriod, Department, CourseMeet
    ...
    def get_student_transcript_data(self, student):
        ...
        for year in student.years:
            ...
            if 'standard_test' in settings.INSTALLED_APPS:
                from standard_test.models import StandardTest
                student.tests = []
