...
from schedule.models import Course, MarkingPeriod
from .models import SchoolYear
from attendance.models import StudentAttendance, CourseAttendance, AttendanceStatus, AttendanceLog
from report_builder.models import Report
import datetime

from django.core.urlresolvers import reverse
from responsive_dashboard.dashboard import AdminListDashlet, LinksListDashlet, dashboards
from .models import Student, UserPreference, Faculty


class ViewStudentDashlet(Dashlet):
    template_name = 'view_student_dashlet.html'

class EventsDashlet(Dashlet):
    template_name = 'events_dashlet.html'
    ...
    links = [
        {
            ...
            'link': reverse('attendance.views.teacher_attendance'),
            'perm': ('attendance.take_studentattendance',),
        },
        {
            'text': 'Take course attendance',
            'link': reverse('attendance.views.select_course_for_attendance'),
            'perm': ('attendance.take_studentattendance',),
        },
        {
            'text': 'Reports',
            'link': reverse('attendance.views.attendance_report'),
