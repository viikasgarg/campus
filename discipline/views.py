...
from profiles.models import UserPreference, SchoolYear, Student
from profiles.xl_report import XlReport
from models import *
from forms import *
import datetime
...
@user_passes_test(lambda u: u.has_perm('discipline.change_studentdiscipline') or u.has_perm('profiles.reports'))
